  ...
  return (
    <div className="space-y-12 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row items-center justify-between gap-6">
        <div>
          <h1 className="text-4xl font-black font-heading uppercase tracking-tight text-white">Магазин <span className="text-[#7e9dff]">Игр</span></h1>
        ...
        <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
          <div className="relative flex-grow md:w-64">
            ...
            <input 
              ...
              className="w-full bg-black/40 border border-white/5 rounded-xl py-3 pl-12 pr-4 text-sm focus:border-[#7e9dff] outline-none transition-all"
            />
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {GAMES.map(game => (
          <div key={game.id} className="glass-card group flex flex-col overflow-hidden hover:border-[#7e9dff]/50 transition-all">
            <div className="relative h-48 overflow-hidden">
              ...
              <div className="absolute top-4 left-4 bg-black/60 backdrop-blur-md px-2 py-1 rounded-lg text-[10px] font-black flex items-center space-x-1">
                <Globe size={10} className="text-[#7e9dff]" />
            ...
            <div className="p-6 flex flex-col flex-grow">
              ...
              <div className="mt-auto flex items-center justify-between">
                ...
                <button className="p-3 bg-white/5 hover:bg-[#7e9dff] hover:text-[#0b0e14] rounded-xl transition-all group/btn">
      ...
      <div className="glass-card p-12 bg-gradient-to-r from-[#7e9dff]/10 to-transparent border-[#7e9dff]/10 flex flex-col md:flex-row items-center justify-between gap-8">
        <div className="space-y-4 max-w-xl">
          <div className="inline-flex items-center space-x-2 bg-[#7e9dff]/20 px-3 py-1 rounded-full text-[#7e9dff] text-[10px] font-black uppercase">
            <Gift size={12} />
        ...
        <button className="bg-[#7e9dff] text-[#0b0e14] px-10 py-5 rounded-2xl font-black text-lg uppercase shadow-xl whitespace-nowrap active:scale-95 transition-all">
          Заказать игру
        </button>
      </div>
    </div>
